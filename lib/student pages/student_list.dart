...
class StudentStaffList extends StatefulWidget {
  StudentStaffList({Key? key, this.title}) : super(key: key);
  ...
  @override
  _StudentStaffListState createState() => _StudentStaffListState();
}

class _StudentStaffListState extends State<StudentStaffList> {
        ...
        children: <Widget>[
          ...
          Expanded(
            child: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                stream: UserModel.getUsersAsStream(searchText),
                initialData: null,
                          ...
                          ButtonBar(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: IconButton(
                                  onPressed: () {
                                    Get.to(() => StaffPage(user: student, initalIndex: 2));
                                  },
