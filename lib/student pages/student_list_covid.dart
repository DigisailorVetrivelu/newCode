...
class StudentStaffListCovid extends StatefulWidget {
  StudentStaffListCovid({Key? key, this.title}) : super(key: key);
  ...
  @override
  _StudentStaffListCovidState createState() => _StudentStaffListCovidState();
}

class _StudentStaffListCovidState extends State<StudentStaffListCovid> {
        ...
        children: <Widget>[
          ...
          Expanded(
            child: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                stream: UserModel.getCovidUsersAsStream(searchText),
                initialData: null,
